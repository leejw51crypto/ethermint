...
ethermintd add-genesis-account %KEY% 1000000000000000000000000000000000000000000aphoton --keyring-backend %KEYRING% --home %HOME%

rem Sign genesis transaction
ethermintd gentx %KEY% 1000000000000000000000aphoton --keyring-backend %KEYRING% --chain-id %CHAINID% --home %HOME%
...
ethermintd start --pruning=nothing %TRACE% --log_level %LOGLEVEL% --minimum-gas-prices=0.0001aphoton  --home %HOME%
