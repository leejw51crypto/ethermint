...
go build  -tags cgo  -tags cgo .\cmd\ethermintd

ethermintd start --pruning=nothing %TRACE% --log_level %LOGLEVEL% --minimum-gas-prices=0.0001aphoton  --json-rpc.address 0.0.0.0:19545
