...
echo $MYMNEMONICS
ethermintd keys add $KEY  --algo "eth_secp256k1" --recover --index 0
echo $MYMNEMONICS
ethermintd keys add $KEY2  --algo "eth_secp256k1" --recover --index 1
...
ethermintd add-genesis-account $KEY 100000000000000000000000000aphoton  

# Sign genesis transaction
ethermintd gentx $KEY 1000000000000000000000aphoton  --chain-id $CHAINID
...
ethermintd start --pruning=nothing  --trace --log_level info
