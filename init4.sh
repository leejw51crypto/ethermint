...
echo $MYMNEMONICS
ethermintd keys add $KEY --keyring-backend os --algo "eth_secp256k1" --recover --index 0
echo $MYMNEMONICS
ethermintd keys add $KEY2 --keyring-backend os --algo "eth_secp256k1" --recover --index 1
...
ethermintd add-genesis-account $KEY 100000000000000000000000000aphoton --keyring-backend os 

# Sign genesis transaction
ethermintd gentx $KEY 1000000000000000000000aphoton --keyring-backend os --chain-id $CHAINID
...
ethermintd start --pruning=nothing --keyring-backend os --trace --log_level info
